...
const GAS_BASE =
  'https://script.google.com/macros/s/AKfycbz1ni2j5qgdj_7Vm5uop2tDOYOEQQ_oW4yWl13ihgDV9Ikb7bJol57nziVoq3i2U1GZrA/exec'

const API_TIMEOUT_MS = 12000

// 위젯 크기 프리셋 — S(카운트만) / L(전체) 두 단계.
// 드래그 리사이즈는 제공하지 않고 헤더 사이즈 토글 버튼으로만 전환
// 각 값은 (위젯 실제 크기 + 외곽 그림자 padding 28px) 합산.
//   S 위젯 240×220 + 28 = 268×248
//   L 위젯 360×560 + 28 = 388×588
const SIZE_PRESETS = {
  S: { width: 268, height: 248 },
  L: { width: 388, height: 588 }
}
